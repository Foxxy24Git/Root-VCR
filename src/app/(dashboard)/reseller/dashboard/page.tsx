...
export default async function ResellerDashboard() {
  ...
  // Fetch dashboard data parallelly
  const [dbUser, wallet, todayVouchers, activeVouchers, recentVouchers, resellerProfiles] = await Promise.all([
    prisma.user.findUnique({ where: { id: user.id }, select: { fee_percentage: true } }),
    ...
    // Available profiles for this reseller
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col gap-2 mb-8">
        ...
        <p className="text-slate-500">Selamat datang kembali, kelola voucher hotspot Anda di sini.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <StatsCard
          ...
          value={todayVouchers}
          icon={Ticket}
          trend={{ value: 0, label: "hari ini" }} // Could be calculated dynamically against yesterday
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-100">
            <div className="p-6 border-b border-slate-100">
              <h2 className="text-lg font-bold text-slate-900">Generate Voucher</h2>
            </div>
            <div className="p-6">
              <GenerateVoucherForm 
        ...
        {/* Right Column: Vouchers Aktif Hari Ini */}
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-100 flex flex-col h-full">
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <h2 className="text-lg font-bold text-slate-900">Voucher Hari Ini</h2>
            ...
            <div className="flex-1 overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead className="bg-slate-50/50 text-slate-500 font-medium">
                  <tr>
                    <th className="px-6 py-4 font-medium uppercase tracking-wider text-xs">Kode</th>
                    <th className="px-6 py-4 font-medium uppercase tracking-wider text-xs">Profile</th>
                    <th className="px-6 py-4 font-medium uppercase tracking-wider text-xs">Status</th>
                    <th className="px-6 py-4 font-medium uppercase tracking-wider text-xs">Harga</th>
                  </tr>
                </thead>
