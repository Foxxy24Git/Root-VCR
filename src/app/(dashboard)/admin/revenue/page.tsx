...
export default async function AdminRevenuePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20 md:pb-0">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Revenue</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-1">Ringkasan revenue bulanan dari penjualan voucher.</p>
      </div>
      <Suspense>
        <RevenueClient
          data={data}
