...
export function PlanFormModal({ plan, onClose, onSaved }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 overflow-y-auto bg-black/40 backdrop-blur-sm p-4 sm:p-6 animate-in fade-in duration-150"
      onClick={(e) => {
        if (e.target === e.currentTarget && !loading) onClose()
      }}
    >
      <div className="relative w-full sm:max-w-2xl mx-auto my-8 sm:my-16 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl flex flex-col">
        {/* Header */}
