        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-2">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg px-4 py-2.5 text-slate-900 dark:text-slate-100 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors"
                placeholder="100000"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg px-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors"
                placeholder="Misal: Transfer Bank / Koreksi"
              />
            </div>

            <div className="bg-slate-50 dark:bg-slate-700/50 border border-slate-100 dark:border-slate-700 rounded-xl p-4 flex flex-col gap-1 text-sm">
              <div className="flex justify-between items-center text-slate-500 dark:text-slate-400">
                <span>Saldo Saat Ini</span>
                <span className="font-medium">Rp {reseller.balance.toLocaleString("id-ID")}</span>
              </div>
              <div className="flex justify-between items-center font-bold text-slate-900 dark:text-slate-100 pt-1 border-t border-slate-200 dark:border-slate-600 mt-1">
                <span>Saldo Setelahnya</span>
                <span className={afterBalance < 0 ? "text-red-500" : "text-green-600 dark:text-green-400"}>
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-6 py-2 bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-white text-white dark:text-slate-900 rounded-lg text-sm font-semibold transition-colors disabled:opacity-50"
            >
